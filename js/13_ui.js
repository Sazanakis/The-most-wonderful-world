...
// ВЕРСИЯ 4.0 – ДОБАВЛЕНО ОТОБРАЖЕНИЕ КОЛИЧЕСТВА СТРОЕК
// ============================================================================
...
// ========================================================================
// ОБНОВЛЁННАЯ ФУНКЦИЯ renderProvinceDashboard – добавлено отображение строек
// ========================================================================
function renderProvinceDashboard() {
    ...
    // ---- БОНУС ОТ ПОСТРОЕК К РОЖДАЕМОСТИ ----
    ...
    if (hasPantheon) {
        buildingBirthBonus = 15; // +15%
    } else if (hasSanctuary) {
        buildingBirthBonus = 5;  // +5%
    }
    ...
    // ---- ВЕРХНЯЯ КАРТОЧКА (общая статистика) ----
...
console.log("✅ 13_ui.js загружен — функции интерфейса (версия 4.0)");