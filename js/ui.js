...
function showTreasuryBreakdown() {
    ...
    const corruption = (typeof peopleState !== 'undefined' && peopleState.corruption) 
        ...
        : 0;
    const corruptionLoss = Math.floor(actualTaxIncome * (corruption / 100));
    ...
    const netChange = finalTaxIncome + totalTradeIncome - armyUpkeep - researcherSalaries;
