// ============================================================================
// МОДУЛЬ 14: init.js
// ВЕРСИЯ 7.0 – ГАРАНТИРОВАННАЯ ИНИЦИАЛИЗАЦИЯ ВСЕХ ПРОВИНЦИЙ, КАРТЫ И ДАННЫХ
// ============================================================================
    ...
    if (!provincesData[provinceId]) {
        ...
        if (provinceId === "orochima") {
            ...
            races = [
                ...
                { name: "Высшие эльфы", adultMale: 300, adultFemale: 350, children: 60, elders: 90, birthRate: 0.5, deathRate: 0.3, despair: 0 },
            ...
            races = [
                ...
                { name: "Высшие эльфы", adultMale: 200, adultFemale: 200, children: 40, elders: 60, birthRate: 0.5, deathRate: 0.3, despair: 0 },
            ...
            races = [
                ...
                { name: "Высшие эльфы", adultMale: 1000, adultFemale: 1200, children: 200, elders: 400, birthRate: 0.5, deathRate: 0.3, despair: 0 }
            ];
            ...
            races = [
                ...
                { name: "Высшие эльфы", adultMale: 15000, adultFemale: 15000, children: 3000, elders: 4000, birthRate: 0.5, deathRate: 0.3, despair: 0 },
            ...
            races = [
                ...
                { name: "Высшие эльфы", adultMale: 300, adultFemale: 300, children: 60, elders: 90, birthRate: 0.5, deathRate: 0.3, despair: 0 },
            ...
            races = [
                ...
                { name: "Вульфины", adultMale: 200, adultFemale: 150, children: 50, elders: 20, birthRate: 1.5, deathRate: 1.5 },
                { name: "Тайро", adultMale: 100, adultFemale: 100, children: 30, elders: 10, birthRate: 2.0, deathRate: 1.0 },
                { name: "Высшие эльфы", adultMale: 150, adultFemale: 150, children: 30, elders: 40, birthRate: 0.5, deathRate: 0.3, despair: 0 },
                { name: "Лепусиды (высшие)", adultMale: 150, adultFemale: 150, children: 60, elders: 20, birthRate: 3.5, deathRate: 1.5 }
            ];
            ...
            races = [
                ...
                { name: "Высшие эльфы", adultMale: 800, adultFemale: 800, children: 200, elders: 300, birthRate: 0.5, deathRate: 0.3, despair: 0 }
            ];
        } else {
            races = [
...
console.log("✅ 14_init.js загружен — версия 7.0 (гарантированная инициализация провинций)");