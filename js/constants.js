...
const PROVINCE_NAMES = {
    ...
    oku_province_3: "Оку (провинция 3)",
    loyalist_province_1: "Лоялистская провинция 1",
    loyalist_province_2: "Лоялистская провинция 2",
    loyalist_province_3: "Лоялистская провинция 3",
    loyalist_province_4: "Лоялистская провинция 4",
    loyalist_province_5: "Лоялистская провинция 5",
    neutral_province_1: "Нейтральная провинция 1",
    neutral_province_2: "Нейтральная провинция 2",
    neutral_province_3: "Нейтральная провинция 3",
    neutral_province_4: "Нейтральная провинция 4",
    neutral_province_5: "Нейтральная провинция 5",
    neutral_province_6: "Нейтральная провинция 6",
    neutral_province_7: "Нейтральная провинция 7",
    proyurgan_province_1: "Проюрганская провинция 1",
    proyurgan_province_2: "Проюрганская провинция 2"
};
const FACTION_NAMES = {
    ...
    unknown_clan_3: "Неизвестный клан (3)",
    unknown_feudal_1: "Неизвестный феодал (1)",
    unknown_feudal_2: "Неизвестный феодал (2)",
    unknown_feudal_3: "Неизвестный феодал (3)",
    unknown_feudal_4: "Неизвестный феодал (4)",
    unknown_feudal_5: "Неизвестный феодал (5)",
    unknown_feudal_6: "Неизвестный феодал (6)",
    unknown_feudal_7: "Неизвестный феодал (7)",
    unknown_feudal_8: "Неизвестный феодал (8)",
    unknown_feudal_9: "Неизвестный феодал (9)",
    unknown_feudal_10: "Неизвестный феодал (10)",
    unknown_feudal_11: "Неизвестный феодал (11)",
    unknown_feudal_12: "Неизвестный феодал (12)",
    unknown_feudal_13: "Неизвестный феодал (13)",
    unknown_feudal_14: "Неизвестный феодал (14)"
};
